...
function calculatePrice($depart, $arrivee, $pick_date, $pick_time, $allerretour) {
    ...
    $value_distance_from_home = $distance_from_home->routes[0]->legs[0]->distance->value;

    // Cas où c'est trop loing
    if ($value_distance_from_home > 120000) {
    ...
    $tranches = array("A" => 20, "B" => 30, "C" => 40, "D" => 50);

    // Si réservation de nuit... prix plus cher!
    if ($pick_hour > 20 OR $pick_hour < 8)
